        ...
        add(
                new ExternalLink(
                    ...
                    protected String load() {
                        ...
                        return AppVersion.getLatest().getApp().getIssueTracker().getHomepage( AppVersion.getLatest().getApp() );
                    }
        ...
        add(
                new ExternalLink(
                    ...
                    protected String load() {
                        ...
                        return AppVersion.getLatest().getApp().getSourceProvider().getHomepage( AppVersion.getLatest().getApp() );
                    }
                }, new LoadableDetachableModel<String>() {
                    @Override
                    protected String load() {
